...
from tests.utils import get_default_test_configuration,\
    ...
    get_default_storm_gateway, get_test_configuration
...
class TestStorageService(unittest.TestCase):
    ...
    def test_storage_service_builder(self):
        ...
        self.assertEqual(service.get_storage_endpoints()[0].get_name(), "SRM_0")
        ...
        # WebDAV - HTTP 8085
        self.assertEqual(service.get_storage_endpoints()[1].get_url(), configuration.get_webdav_endpoints()[0])
        ...
        self.assertEqual(service.get_storage_endpoints()[1].get_name(), "HTTP_0")
        ...
        # WebDAV - HTTPS 8443
        self.assertEqual(service.get_storage_endpoints()[2].get_url(), configuration.get_webdav_endpoints()[1])
        ...
        self.assertEqual(service.get_storage_endpoints()[2].get_name(), "HTTPS_0")
        ...
        self.assertEqual(service.get_storage_endpoints()[3].get_url(), configuration.get_webdav_endpoints()[2])
        self.assertEqual(service.get_storage_endpoints()[3].get_type(), "DAV")
        self.assertEqual(service.get_storage_endpoints()[3].get_version(), "1.1")
        self.assertEqual(service.get_storage_endpoints()[3].get_name(), "HTTPS_1")
        self.assertEqual(service.get_storage_endpoints()[3].get_quality_level(), configuration.get_quality_level())
        self.assertNotEqual(service.get_storage_endpoints()[3].get_capabilities().index("data.management.transfer"), -1)
        self.assertNotEqual(service.get_storage_endpoints()[3].get_capabilities().index("data.management.storage"), -1)
        self.assertEqual(service.get_storage_endpoints()[3].get_assigned_shares(), ["all"])
    ...
    def test_storage_service_builder_with_gridhttps_env_vars(self):
        configuration = get_test_configuration("resources/storm.gridhttps.def")
        storm_gateway = get_default_storm_gateway()
        # build space info
        space_info = SpaceInfoBuilder(configuration, storm_gateway).build()
        # build storage service and check results
